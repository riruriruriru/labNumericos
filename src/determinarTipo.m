...
if n ~= m
    ...
    if n>300
        ...
        elseif c4 == 1 && c1 ~= 1 && c5 == 1
            string = 'Matriz simetrica y dispersa. Se resolverá con housholder, givens y LU doolittle';
            disp(string)
            %aplicar 3 metodos
        elseif c4 == 1 && c1 ~= 1 %matriz simetrica no definida positiva
            %aplicar housholder
        ...
        elseif c5 == 1 %matriz dispersa
            string = 'Matriz dispersa. Se resolverá con givens';
            disp(string)
            %aplicar givens
        else
